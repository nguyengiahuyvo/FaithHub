...
const translations = {
  ...
  auth_login_title: { en: "Welcome back.", de: "Willkommen zurück.", vi: "Chào mừng trở lại." },
  auth_login_desc: {
  ...
  auth_login_switch_label: { en: "New here?", de: "Neu hier?", vi: "Mới ở đây?" },
  auth_login_switch_action: { en: "Create an account", de: "Konto erstellen", vi: "Tạo tài khoản" },
  auth_signup_title: { en: "Create your account.", de: "Erstelle dein Konto.", vi: "Tạo tài khoản." },
  auth_signup_desc: {
  ...
  auth_signup_switch_label: { en: "Already have an account?", de: "Bereits ein Konto?", vi: "Đã có tài khoản?" },
  auth_signup_switch_action: { en: "Log in instead", de: "Stattdessen anmelden", vi: "Đăng nhập" },
  auth_full_name: { en: "Full name", de: "Vollständiger Name", vi: "Họ và tên" },
  auth_full_name_placeholder: { en: "Enter your full name", de: "Gib deinen vollständigen Namen ein", vi: "Nhập họ và tên" },
  auth_email: { en: "Email", de: "E-Mail", vi: "Email" },
  auth_email_placeholder: { en: "you@example.com", de: "du@beispiel.de", vi: "ban@example.com" },
  auth_password: { en: "Password", de: "Passwort", vi: "Mật khẩu" },
  auth_password_placeholder_login: { en: "Enter your password", de: "Passwort eingeben", vi: "Nhập mật khẩu" },
  auth_password_placeholder_signup: { en: "Create a password", de: "Passwort erstellen", vi: "Tạo mật khẩu" },
  auth_confirm_password: { en: "Confirm password", de: "Passwort bestätigen", vi: "Xác nhận mật khẩu" },
  auth_confirm_password_placeholder: { en: "Re-enter your password", de: "Passwort erneut eingeben", vi: "Nhập lại mật khẩu" },
  auth_pill_devotionals: { en: "Daily devotionals", de: "Tägliche Andachten", vi: "Suy ngẫm hàng ngày" },
  auth_pill_prayer: { en: "Prayer journal", de: "Gebetstagebuch", vi: "Nhật ký cầu nguyện" },
  ...
  auth_error_missing: { en: "Missing fields", de: "Fehlende Felder", vi: "Thiếu thông tin" },
  ...
  auth_error_mismatch: { en: "Passwords don't match", de: "Passwörter stimmen nicht überein", vi: "Mật khẩu không khớp" },
  ...
  auth_error_short: { en: "Password too short", de: "Passwort zu kurz", vi: "Mật khẩu quá ngắn" },
  ...
  auth_error_login: { en: "Login failed", de: "Anmeldung fehlgeschlagen", vi: "Đăng nhập thất bại" },
  auth_error_signup: { en: "Sign-up failed", de: "Registrierung fehlgeschlagen", vi: "Đăng ký thất bại" },
  auth_error_apple: { en: "Apple Sign-In failed", de: "Apple-Anmeldung fehlgeschlagen", vi: "Đăng nhập Apple thất bại" },
  ...
  // Home — join org
  join_title: { en: "Join your organization", de: "Tritt deiner Organisation bei", vi: "Tham gia tổ chức" },
  join_desc: {
  ...
  join_label: { en: "Organization code", de: "Organisationscode", vi: "Mã tổ chức" },
  join_placeholder: { en: "e.g. GRACE-2024", de: "z.B. GRACE-2024", vi: "VD: GRACE-2024" },
  join_button: { en: "Join Organization", de: "Organisation beitreten", vi: "Tham gia tổ chức" },
  join_error_title: { en: "Couldn't join", de: "Beitritt fehlgeschlagen", vi: "Không thể tham gia" },
  join_error_empty: {
  ...
  home_no_members: { en: "No members yet.", de: "Noch keine Mitglieder.", vi: "Chưa có thành viên." },
  home_member_fallback: { en: "Member", de: "Mitglied", vi: "Thành viên" },

  // Tasks
  tasks_title: { en: "Tasks", de: "Aufgaben", vi: "Công việc" },
  tasks_empty: { en: "No tasks yet", de: "Noch keine Aufgaben", vi: "Chưa có công việc" },
  tasks_empty_hint: { en: "Tap + to create your first task", de: "Tippe auf + für die erste Aufgabe", vi: "Nhấn + để tạo công việc đầu tiên" },
  tasks_new: { en: "New Task", de: "Neue Aufgabe", vi: "Công việc mới" },
  tasks_title_label: { en: "Title", de: "Titel", vi: "Tiêu đề" },
  tasks_title_placeholder: { en: "What needs to be done?", de: "Was muss erledigt werden?", vi: "Cần làm gì?" },
  tasks_desc_label: { en: "Description (optional)", de: "Beschreibung (optional)", vi: "Mô tả (tùy chọn)" },
  tasks_desc_placeholder: { en: "Add details...", de: "Details hinzufügen...", vi: "Thêm chi tiết..." },
  ...
  cal_event_name: { en: "Event name", de: "Veranstaltungsname", vi: "Tên sự kiện" },
  ...
  profile_display_name: { en: "Display name", de: "Anzeigename", vi: "Tên hiển thị" },
  ...
  profile_leave_org: { en: "Leave organization", de: "Organisation verlassen", vi: "Rời tổ chức" },
  profile_preferences: { en: "Preferences", de: "Einstellungen", vi: "Cài đặt" },
  profile_notifications: { en: "Notifications", de: "Benachrichtigungen", vi: "Thông báo" },
  profile_appearance: { en: "Appearance", de: "Erscheinungsbild", vi: "Giao diện" },
  ...
  profile_signout_failed: { en: "Sign-out failed", de: "Abmeldung fehlgeschlagen", vi: "Đăng xuất thất bại" },
  profile_signout_error: {
    en: "Something went wrong. Please try again.",
    de: "Etwas ist schiefgelaufen. Bitte versuche es erneut.",
    vi: "Đã xảy ra lỗi. Vui lòng thử lại.",
  },
  profile_member_fallback: { en: "FaithHub Member", de: "FaithHub-Mitglied", vi: "Thành viên FaithHub" },
...
export function tArray(key: "cal_months" | "cal_days", lang: Language): readonly string[] {
  const entry = translations[key];
